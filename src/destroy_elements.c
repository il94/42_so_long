...
int	destroy_elements(t_game *game)
{
	...
	mlx_destroy_image(game->mlx, game->m_hammer_b_left_light.img);
	mlx_destroy_image(game->mlx, game->m_hammer_b_left_light_2.img);
	mlx_destroy_image(game->mlx, game->m_hammer_b_right_light.img);
	mlx_destroy_image(game->mlx, game->m_hammer_b_right_light_2.img);
	mlx_destroy_image(game->mlx, game->m_hammer_left_light.img);
	mlx_destroy_image(game->mlx, game->m_hammer_left_light_2.img);
	mlx_destroy_image(game->mlx, game->m_hammer_left_light_3.img);
	mlx_destroy_image(game->mlx, game->m_hammer_right_light.img);
	mlx_destroy_image(game->mlx, game->m_hammer_right_light_2.img);
	mlx_destroy_image(game->mlx, game->m_hammer_right_light_3.img);
	mlx_destroy_image(game->mlx, game->m_static_b_left_light.img);
	mlx_destroy_image(game->mlx, game->m_static_b_right_light.img);
	mlx_destroy_image(game->mlx, game->m_static_left_light.img);
	mlx_destroy_image(game->mlx, game->m_static_right_light.img);
	mlx_destroy_image(game->mlx, game->m_walk_b_left_light.img);
	mlx_destroy_image(game->mlx, game->m_walk_b_left_light_2.img);
	mlx_destroy_image(game->mlx, game->m_walk_b_left_light_3.img);
	mlx_destroy_image(game->mlx, game->m_walk_b_right_light.img);
	mlx_destroy_image(game->mlx, game->m_walk_b_right_light_2.img);
	mlx_destroy_image(game->mlx, game->m_walk_b_right_light_3.img);
